...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("getPriceTest(): Vending.getPrice() " + getPriceTest());
    ...
    private static boolean getPriceTest(){
        ...
        /*double test5 = vendingMachine.getPrice("");
        if (test1 != 1000){
            System.err.println("getPriceTest: test2 ERROR");
            return false;
        }
    ...
    private static boolean availableCansTest(){
        ...
        if (test1 != 13){
            System.out.println("availableCansTest: test1 ERROR");
            return false;
        }
        int test2 = vendingMachine.availableCans("Sharbat");
        if (test2 != 2){
            System.out.println("availableCansTest: test2 ERROR");
            return false;
        }
        return true;
    }
    ...
    private static boolean sellTest(){
        ...
        if (test3 != -1){
            System.out.println("sellTest: test3 ERROR");
            return false;
        }
        int test4 = vendingMachine.sell("Asal choy", 3);
        if (test4 != -1){
            System.out.println("sellTest: test4 ERROR");
            return false;
        }
        return true;
    }
